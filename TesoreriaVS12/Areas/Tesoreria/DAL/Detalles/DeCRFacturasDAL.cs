...
{
    public class DeCRFacturasDAL : DALGeneric, IRepository<De_CR_Facturas>
    {
        ...
        public void DeleteAll(List<De_CR_Facturas> entity)
        {
            foreach (De_CR_Facturas item in entity)
            {
                this.Db.De_CR_Facturas.Remove(item);
            }
        }
        public void Save()
        {

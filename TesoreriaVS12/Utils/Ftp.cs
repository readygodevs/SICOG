...
namespace TesoreriaVS12.Utils
{
    public class Ftp
    {
        ...
        /// <summary>
        /// Ignorar este constructor, es el Jul's
        /// </summary>
        /// <param name="Parametros"></param>
        //public Ftp(bool Parametros)
        //{
        //    BD_TramitesEntities db = new BD_TramitesEntities();
        //    List<CA_Parametros> param = db.CA_Parametros.ToList();
        //    userFtp = param.Find(x => x.Referencia.Equals("userFtp")).Valor;
        //    passFtp = param.Find(x => x.Referencia.Equals("passFtp")).Valor;
        //    urlServer = new Uri(param.Find(x=> x.Referencia.Equals("urlServer")).Valor);
        //}
